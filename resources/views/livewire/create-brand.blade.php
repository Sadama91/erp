<div class="fixed inset-0 flex items-center justify-center z-50">
    <div class="bg-white rounded shadow-lg p-6 w-1/3">
        <form wire:submit.prevent="save">
            <h2 class="text-lg font-semibold mb-4">{{ $brandId ? 'Bewerken' : 'Nieuw Merk' }}</h2>

            <div class="mb-4">
                <label for="name" class="block text-sm font-medium text-gray-700">Merk naam</label>
            ...
            <div class="flex justify-end">
                <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">{{ $brandId ? 'Bijwerken' : 'Toevoegen' }}</button>
