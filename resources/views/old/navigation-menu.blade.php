<nav x-data="{ open: false, productsOpen: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex items-center">
                ...
                <div x-data="{ inkoopOpen: false }" class="relative">
                    <button @click="inkoopOpen = !inkoopOpen" class="text-gray-500 hover:bg-gray-100 px-3 py-2 rounded-md text-sm font-medium">
                        {{ __('Inkoop') }}
                    </button>
                    <div x-show="inkoopOpen" @click.away="inkoopOpen = false" class="absolute z-10 bg-white text-black rounded-md shadow-lg mt-1">
                        <x-responsive-nav-link href="{{ route('suppliers.index') }}">{{ __('Leveranciers') }}</x-responsive-nav-link>
                        <x-responsive-nav-link href="{{ route('images.index') }}">{{ __('Afbeeldingen') }}</x-responsive-nav-link>
                     </div>
                </div>
                <div x-data="{ settingsOpen: false }" class="relative">
                    <button @click="settingsOpen = !settingsOpen" class="text-gray-500 hover:bg-gray-100 px-3 py-2 rounded-md text-sm font-medium">
                        {{ __('Instellingen') }}
                    </button><div x-show="settingsOpen" @click.away="settingsOpen = false" class="absolute z-10 bg-white text-black rounded-md shadow-lg mt-1">
                        <x-dropdown-link href="{{ route('parameters.index') }}">{{ __('Parameters') }}</x-responsive-nav-link>
                      </div>                        
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div x-show="productsOpen" @click.away="productsOpen = false" class="mt-1">
